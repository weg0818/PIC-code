...
namespace gbc {
    ...
    public:
        ...
        VertexR2(const int bSize) : super(), _x(0.0), _y(0.0), _b(bSize, 0.0), _tol(1.0e-10) { }
        ...
        VertexR2(VertexExpressionR2<E> const &v) {
            ...
            _b.resize(v.size());
            for (int i = 0; i != v.size(); ++i) _b[i] = v.b((int) i);
        ...
        void operator+=(const VertexR2 &v) {
            ...
            for (int i = 0; i < bSize; ++i) _b[i] += v.b()[i];
        }
        ...
        void operator*=(const double scalar) {
            ...
            for (int i = 0; i < bSize; ++i) _b[i] *= scalar;
        }
        ...
        VertexR2 operator+(const VertexR2 &v) const {
            return VertexR2(_x + v.x(), _y + v.y());
        }
        ...
        VertexR2 operator*(const double scalar) const {
            return VertexR2(_x * scalar, _y * scalar);
        }

        // Division of a vertex by a scalar
        VertexR2 operator/(double scalar) const {
